...
export const SiteFooter: React.FC = () => {
  return (
    <footer className="border-t border-line bg-white px-4 py-12 text-[15px] text-muted sm:px-6 sm:py-16 dark:border-white/10 dark:bg-[#141824]">
      <div className="mx-auto max-w-7xl space-y-8">
        <div className="flex flex-col gap-8 lg:flex-row lg:items-start lg:justify-between">
          <div className="max-w-sm">
            <div className="flex items-center gap-3">
              ...
              />
              <span className="text-xl font-semibold text-[#323243] dark:text-[#E2E4ED]">
                Placement<span className="text-primary">Wire</span>
              </span>
            </div>
            <p className="mt-3 text-[15px] font-normal leading-relaxed">
              Your placement emails, organized. Built for students of St. Andrews Institute of
              Technology &amp; Management — private by architecture, not by promise.
            </p>
          </div>

          <nav className="grid grid-cols-2 gap-x-12 gap-y-3 text-base font-medium sm:flex sm:flex-wrap sm:items-center sm:gap-x-7" aria-label="Footer">
        ...
        <div className="flex flex-col items-center justify-between gap-2 border-t border-line dark:border-white/10 pt-6 text-sm text-muted dark:text-[#94A3B8] sm:flex-row">
