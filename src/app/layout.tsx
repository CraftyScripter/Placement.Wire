    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'PlacementWire — Your Placement Emails. Organized.',
      },
      { url: '/icon_light.png', width: 512, height: 512, alt: 'PlacementWire' },
    ],
  },
  twitter: {
...
export default function RootLayout({
  ...
  return (
    <html lang="en" className={`${outfit.variable} ${display.variable}`} suppressHydrationWarning>
      <head>
        <script
