    ...
    <div className="space-y-5">
      ...
      <Card>
        ...
        <p className="mt-4 text-xs leading-relaxed text-slate-500 dark:text-[#94A3B8]">
          Backups are saved to <span className="font-mono text-slate-700 dark:text-slate-300 font-semibold">PlacementWire_Data/admin_analytics.dev.json</span> inside your connected Google Drive account — a separate snapshot that never touches the production live log (<span className="font-mono">admin_analytics.json</span>).
        </p>
      </Card>
